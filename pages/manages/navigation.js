...
const LiParent = styled.li(({ currentRouter }) => ({
  '& > a': {
    fontWeight: currentRouter ? '700' : null,
    color: currentRouter ? hex.light : `rgba(${rgba.light70})`,
  },
  '& ol': {
    display: currentRouter ? 'flex!important' : null,
  },
}))

const LiChild = styled.li(({ currentRouter }) => ({
  '& a': {
    borderRadius: currentRouter ? Rem(52) : null,
    backgroundColor: currentRouter ? hex.mint : null,
    fontWeight: currentRouter ? '700' : null,
